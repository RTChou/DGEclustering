...
def main():
    ...
    for index, filepath in enumerate(deseq2_outputs):
        for filepath_2 in deseq2_outputs[index+1:len(deseq2_outputs)]:
            ...
            if dataset.shape[0] == dataset_2.shape[0] and dataset.shape[1] == dataset_2.shape[1] and column_name in dataset.columns and column_name in dataset_2.columns:
    ...
    for paired_file in paired_files:
        ...
        if args.fish_plot == 1:
            plotting.fish_plot(paired_file['file_1'], paired_file['file_2'], gene_col=args.gene_col, args.root_dir+'/fish_plots')
        if args.scatter_plot == 1:
