...
```{r}
gene.col <- 'GENEID'
all <- 'rapamycin.GDT.t5h.vs.control.GDT.t5h.tsv'
...
```{r}
file1 <- 'rapamycin.GDT.t2h.vs.control.GDT.t2h.tsv'
file2 <- 'control.GDT.t2h.vs.control.GDT.t0.tsv'
cluster.filepath <- 'intego_result_2.tsv'
out.dir <- './rapamycin_control_2'
